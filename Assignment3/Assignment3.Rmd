...
```{r echo=F, warning=F, message=F, error=F, fig.cap="Distribution of household size"}
=======
...
<<<<<<< HEAD
|Income Level |Mean Probability|
|-------------|-----------------|
|Highest quartile |`r round(mean(EVINTEREST$EVinterest[EVINTEREST$high==1]),4)*100`%|
|Second highest quartile|`r round(mean(EVINTEREST$EVinterest[EVINTEREST$highermiddle==1]),4)*100`%|
|Second lowest quartile|`r round(mean(EVINTEREST$EVinterest[EVINTEREST$lowermiddle==1]),4)*100`%|
|Lowest quartile|`r round(mean(EVINTEREST$EVinterest[EVINTEREST$low==1]),4)*100`%|
=======
...
>>>>>>> 0133c4822cb7e45339d24228c1ce2cac014c6fbb
