...
setwd("E:\\—ßœ∞œ‡πÿ\\R\\Introduction-to-Collaborative-Social-Science-Data-Analysis\\Collaborative-Data-Analysis-Assignment2\\Assignment3")
...
```{r echo=F, warning=F, message=F, error=F, fig.cap="Distribution of respondent's age"}
...
```{r echo=F, warning=F, message=F, error=F, fig.cap="Distribution of respondent's income"}
...
```{r echo=F, warning=F, message=F, error=F, fig.cap="Distribution of number of cars"}
