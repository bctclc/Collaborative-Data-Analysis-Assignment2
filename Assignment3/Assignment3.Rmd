...
**`r tablecap("by-income", "Probability by Income Level")`**
...
Probabilities of different income groups comfirms our previous interpretation of the regression results that only the highest quartile group has a significantly higher interest, though the genereal 
