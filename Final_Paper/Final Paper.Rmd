...
#put them in one
grid.arrange(ageEN, sexEN, incomeEN, collegeEN, licenceEN,carnoEN,scotEN, ncol=1, nrow=7, newpage=TRUE, widths=3000)
```
...
#put them in one
grid.arrange(ageENC, sexENC, incomeENC, collegeENC, licenceENC,carnoENC,scotENC, ncol=1, nrow=7, newpage=TRUE, widths=3000)
```
