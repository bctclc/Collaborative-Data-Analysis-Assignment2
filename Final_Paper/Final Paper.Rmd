...
Each of the variables are summarized as follows:

* **EVinterest**: `r round(mean(EVINTEREST$EVinterest)*100, digits=2)` % of respondents have interests in EVs
...
#put them in one
grid.arrange(ageEN, sexEN, incomeEN, collegeEN, licenceEN,carnoEN,scotEN, ncol=2, nrow=4, newpage=TRUE)
```
...
#put them in one
grid.arrange(ageENC, sexENC, incomeENC, collegeENC, licenceENC,carnoENC,scotENC, ncol=2, nrow=4, newpage=TRUE)
```
