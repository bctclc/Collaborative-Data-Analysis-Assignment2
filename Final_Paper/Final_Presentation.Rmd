...
## Data Source
- Name: ["Opinions and Lifestyle Survey, Electric Vehicles Module, February 2014 and February 2015"](https://discover.ukdataservice.ac.uk/Catalogue/?sn=7571&type=Data%20catalogue) 
...
```{r echo=F, warning=F, message=F, error=F, results='asis', fig.width = 10}
# summary of EVinterest
Region <- c('North \n East','North \n West','Yorkshire \n Humber','East \n Midlands', 'West \n Midrands',
            'East of \n England','London','South \n East','South \n West','Wales', 'Scotland', 'National \n Ave.')
...
Intsum <- data.frame(Region=Region, Interest=IntRegion)

barplot(IntRegion, names.arg=Region, cex.names=0.7)
```
`r round(mean(EVINTEREST$EVinterest)*100, digits=2)` % of British People are interested in EVs

## Descriptive Analysis | Independent Variables {.columns-2}
...
- `r round(mean(EVINTEREST$Scotland)*100, digits=2)`% in Scotland
- Income level:
